...
async function migrate() {
  ...
  const scholarshipTypes = [
    ['អាហារូបករណ៍៤០% សិក្សារយៈពេល៤ឆ្នាំ របស់អង្គការកុមារមេគង្គកម្ពុជា','40% Scholarship for 4 Years - Mekong Child Organization',40,4,'អង្គការកុមារមេគង្គកម្ពុជា','អាហារូបករណ៍៤០% សម្រាប់សិស្សដែលមានលទ្ធផលសិក្សាល្អ'],
    ['អាហារូបករណ៍៥០% សិក្សារយៈពេល២ឆ្នាំ របស់សាកលវិទ្យាល័យជាតិមានជ័យ','50% Scholarship for 2 Years - NMU',50,2,'សាកលវិទ្យាល័យជាតិមានជ័យ','អាហារូបករណ៍៥០% សម្រាប់និស្សិតសាកលវិទ្យាល័យជាតិមានជ័យ'],
    ['អាហារូបករណ៍១០០% សិក្សារយៈពេល៤ឆ្នាំ របស់រដ្ឋាភិបាល','100% Full Scholarship for 4 Years - Government',100,4,'រដ្ឋាភិបាលកម្ពុជា','អាហារូបករណ៍ពេញ១០០% សម្រាប់សិស្សពូកែ']
  ];
  for (const [nkh, nen, cov, dur, prov, desc] of scholarshipTypes) {
    await conn.query('INSERT INTO scholarship_types (name_kh, name_en, coverage_percentage, duration_years, provider_name, description) VALUES (?, ?, ?, ?, ?, ?)', [nkh, nen, cov, dur, prov, desc]);
  }
